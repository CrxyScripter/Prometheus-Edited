...
settings = {
    "title" : "Solar V1.4",
    "desc" : "crxyscripter.github.io"
}
#<------------------------------------------------------------------------------------------------>

#<------------------------------------------------------------------------------------------------>
status = {
    "check" : "<:check:1084669728196407346>",
    "wrong" : "<:fail:1084670848021057588>",
    "idle" : "<:progress:1084670072573931621>",
    "lock" : "<:lockicon:1084671498037514351>"
}
#<------------------------------------------------------------------------------------------------>
...
def obfuscation(path, author):
    ...
    if os.path.exists(f".//obfuscated//ArrowBrew-{author}-Obfuscated.lua"):
        os.remove(f".//obfuscated//ArrowBrew-{author}-Obfuscated.lua")

    f = open(f".//obfuscated//ArrowBrew-{author}-Obfuscated.lua", "a")
    f.write(output)
    f.close()
            ...
            if message.channel.type is discord.ChannelType.private:
                if message.attachments[0].url:
                    if '.lua' not in url:
                        ...
                        dm = await message.author.create_dm()
                        await dm.send(file=discord.File(f".//obfuscated//ArrowBrew-{author}-Obfuscated.lua"))
    except:
        pass
#<------------------------------------------------------------------------------------------------>
